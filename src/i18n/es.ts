const es: Record<string, string> = {
  ...
  'subscription.upgradeToPro': 'Actualizar a Pro',
  'subscription.downgradeToStarter': 'Cambiar a Starter',
  ...
  'subscription.upgradeConfirmTitle': 'Actualizar a Plan Pro',
  'subscription.downgradeConfirmTitle': 'Cambiar a Plan Starter',
  'subscription.upgradeProration': 'Se te cobrara {{amount}} por el resto de este periodo de facturacion.',
  'subscription.downgradeInfo': 'Tu plan cambiara a Starter al final de tu periodo de facturacion actual. Mantendras las funciones Pro hasta entonces.',
