const en: Record<string, string> = {
  ...
  'reading.lowerTitle': 'Reading Too Low',
  'reading.lowerDescription': 'The entered reading is lower than the previous reading. Please check the meter and try again.',
  ...
  'user.seatLimitDesc': "You've reached the user limit for your current plan.\nTo invite another admin or meter reader, add more user seats from your subscription page.",
  'user.addUserSeats': 'Add User Seats',
  ...
  'location.deniedDescription': 'This app needs your location to work properly, but access is currently blocked.',
  'location.deniedInstructions': 'Open your device Settings, go to Apps, find this app, then tap Permissions \u2192 Location and select "Allow while using the app".',
  'location.deniedHint': 'Still not working? Make sure Location / GPS is turned on in your device\u2019s main settings.',
  ...
  'common.requiresInternet': 'This action requires an internet connection.',
