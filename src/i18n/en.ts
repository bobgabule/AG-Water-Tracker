const en: Record<string, string> = {
  ...
  'subscription.downgradeToStarter': 'Downgrade to Starter',
  ...
  'subscription.upgradeConfirmTitle': 'Upgrade to Pro Plan',
  'subscription.downgradeConfirmTitle': 'Downgrade to Starter Plan',
  'subscription.upgradeProration': 'You will be charged {{amount}} for the remainder of this billing period.',
  'subscription.downgradeInfo': 'Your plan will change to Starter at the end of your current billing period. You will keep Pro features until then.',
