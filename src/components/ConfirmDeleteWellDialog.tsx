...
export default function ConfirmDeleteWellDialog({
  open,
  onClose,
  onConfirm,
  wellName,
  loading,
}: ConfirmDeleteWellDialogProps) {
  return (
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Delete <span className="text-white font-medium">{wellName}</span> and all its
              readings and allocations? This cannot be undone.
            </p>
