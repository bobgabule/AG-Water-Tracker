...
export default function ConfirmDeleteReadingDialog({
  open,
  onClose,
  onConfirm,
  readingValue,
  readingDate,
  loading,
}: ConfirmDeleteReadingDialogProps) {
  return (
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Delete the reading{' '}
              <span className="text-white font-medium">{readingValue}</span> from{' '}
              <span className="text-white font-medium">{readingDate}</span>? This
              cannot be undone.
            </p>
