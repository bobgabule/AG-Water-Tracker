  ...
  return (
    <Marker latitude={latitude} longitude={longitude} anchor="bottom">
      <div className="flex flex-col items-center">
        {/* Pulsing circle effect - using animate-pulse for better mobile performance */}
        <div className="absolute -top-1 w-12 h-12 rounded-full bg-blue-500/30 animate-pulse" />
