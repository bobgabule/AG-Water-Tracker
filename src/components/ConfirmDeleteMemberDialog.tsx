...
export default function ConfirmDeleteMemberDialog({
  open,
  onClose,
  onConfirm,
  memberName,
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Remove <span className="text-white font-medium">{memberName}</span> from
              your farm? They will lose access and can be re-invited later.
            </p>
