...
### Phase 39: Stripe-based first login flow for farm owners with separate owner and invite user onboarding
...
### Phase 40: Update subscription page with hybrid approach for upgrading, downgrading, seat limits, payment method, transactions, and plan status

**Goal:** Subscription page shows real Stripe plan status, allows in-app plan changes with proration preview, links to Stripe Customer Portal for payment method management, displays recent transactions, and shows seat/well usage with progress indicators
**Requirements**: SUB-01, SUB-02, SUB-03, SUB-04, SUB-05, SUB-06, SUB-07, SUB-08, SUB-09
**Depends on:** Phase 39
**Plans:** 2/2 plans complete
