-- =============================================================================
-- Migration 059: Allow admins to invite other admins
-- =============================================================================
-- Previously admins were blocked from inviting admin-role users by a hard guard.
-- Seat limit enforcement already prevents over-allocation, making the guard
-- redundant. Remove it so admins with available seats can invite other admins.
-- =============================================================================
